...
axs[0, 0].legend()
axs[0, 0].set_xticks([-np.pi, -np.pi* 3/4, -np.pi/2, -np.pi/4, 0, np.pi/4, np.pi/2,np.pi* 3/4, np.pi])
axs[0, 0].set_xticklabels([r'$-\pi$',r'$-3\pi/4$', r'$-\pi/2$', r'$-\pi/4$', r'$0$', r'$\pi/4$', r'$\pi/2$',r'$3\pi/4$', r'$\pi$'])

# Confirmation of total length
...
axs[0, 1].legend()
axs[0, 1].set_xticks([-np.pi, -np.pi* 3/4, -np.pi/2, -np.pi/4, 0, np.pi/4, np.pi/2,np.pi* 3/4, np.pi])
axs[0, 1].set_xticklabels([r'$-\pi$',r'$-3\pi/4$', r'$-\pi/2$', r'$-\pi/4$', r'$0$', r'$\pi/4$', r'$\pi/2$',r'$3\pi/4$', r'$\pi$'])

# Tendon1 and Tendon2 lengths
...
axs[1, 0].legend()
axs[1, 0].set_xticks([-np.pi, -np.pi* 3/4, -np.pi/2, -np.pi/4, 0, np.pi/4, np.pi/2,np.pi* 3/4, np.pi])
axs[1, 0].set_xticklabels([r'$-\pi$',r'$-3\pi/4$', r'$-\pi/2$', r'$-\pi/4$', r'$0$', r'$\pi/4$', r'$\pi/2$',r'$3\pi/4$', r'$\pi$'])

# Tendon components l1 and l2
...
axs[1, 1].legend()
axs[1, 1].set_xticks([-np.pi, -np.pi* 3/4, -np.pi/2, -np.pi/4, 0, np.pi/4, np.pi/2,np.pi* 3/4, np.pi])
axs[1, 1].set_xticklabels([r'$-\pi$',r'$-3\pi/4$', r'$-\pi/2$', r'$-\pi/4$', r'$0$', r'$\pi/4$', r'$\pi/2$',r'$3\pi/4$', r'$\pi$'])
...
axs[0, 2].legend()
axs[0, 2].set_xticks([-np.pi, -np.pi* 3/4, -np.pi/2, -np.pi/4, 0, np.pi/4, np.pi/2,np.pi* 3/4, np.pi])
axs[0, 2].set_xticklabels([r'$-\pi$',r'$-3\pi/4$', r'$-\pi/2$', r'$-\pi/4$', r'$0$', r'$\pi/4$', r'$\pi/2$',r'$3\pi/4$', r'$\pi$'])
axs[0, 2].set_yticks([-np.pi, -np.pi* 3/4, -np.pi/2, -np.pi/4, 0, np.pi/4, np.pi/2,np.pi* 3/4, np.pi])
axs[0, 2].set_yticklabels([r'$-\pi$',r'$-3\pi/4$', r'$-\pi/2$', r'$-\pi/4$', r'$0$', r'$\pi/4$', r'$\pi/2$',r'$3\pi/4$', r'$\pi$'])

print("total_length : ", total_length(np.pi / 180 * 105 / 4))
print("tendon1 : ", tendon1(np.pi / 180 * 105 / 4))
print("tendon2 : ", tendon2(np.pi / 180 * 105 / 4))
